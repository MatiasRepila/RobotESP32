...
// Leer aceleración (g) y gyro (deg/s) escalados (gyro incluye bias removido)
...
// Paso de filtro complementario clásico:
// alpha en [0..1], p.ej. 0.98 a 100 Hz.
// Actualiza imu->roll_deg / imu->pitch_deg y opcionalmente los devuelve en out.
...
static inline float mpu6050_get_pitch(const mpu6050_t *imu){ return imu->pitch_deg; }
